...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInRes?.error) {
        toast.error('Аккаунт создан, но ошибка входа. Попробуйте войти вручную.')
  ...
  return (
    <AuthLayout title="Создать аккаунт" description="Зарегистрируйтесь для доступа к ZentroX">
